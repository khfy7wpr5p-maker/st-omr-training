#!/usr/bin/env python3
"""Durable Colab runner for Meter V3-A1 without full D10 materialization."""
...
def _run(args: argparse.Namespace, status: DurableStatus) -> dict[str, object]:
    ...
    if prepared.staged_image_count != 1_736:
        raise RuntimeError("V3-A1 sparse transport must stage exactly 1,736 images")
    if prepared.meter_label_count != 11_064:
        raise RuntimeError("V3-A1 sparse transport must validate exactly 11,064 Meter labels")
